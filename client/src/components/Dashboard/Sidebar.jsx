...
const Sidebar = () => {
    ...
    const sidebarLinks = [
        ...
        {name: "AddTour", path: "/admin/add-tour",icon: assets.addIcon},
        {name: "ListTour", path: "/admin/list-tour",icon: assets.listIcon},
    ]
    ...
    transition-all duration-300'>
        {sidebarLinks.map((item,index)=>(
            ...
            `flex items-center py-3 px-4 md:px-8 gap-3 transition-colors duration-200 ${
                isActive
                    ? "border-r-4 md:border-r-[6px] bg-blue-600/10 border-blue-600 text-blue-600 font-semibold"
