  ...
  return (
    ...
    lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full'> 
            <Title align='left' title='Ưu đãi đặc biệt' subTitle='
            Hãy tận dụng các ưu đãi trong thời gian có hạn và những gói dịch vụ đặc biệt của chúng tôi 
            để nâng cao kỳ nghỉ của bạn và tạo nên những kỷ niệm khó quên' />
